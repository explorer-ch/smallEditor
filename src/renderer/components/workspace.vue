<template>
  <div class="workspace" ref="container">
      ...
      <editArea :menuWid="menuWid" :tabh="tabH" v-for="(tabmes, index) in tabmesArr" :key="tabmes.allname" :txt="tabmes.data" :id="tabmes.allname" :ctab="ctabname" v-show="tabKey===index" :pos="scrollPos" @changeEdit="changeTabState" @write="sendwrite"></editArea>
    </div>
  </div>
</template>
